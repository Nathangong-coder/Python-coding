...
#explore data in anscombe
print(anscombe_df.info())
#.head() defaults 5, but can become 10 if 10 is in the parantheses
print(anscombe_df.head(10))
print(anscombe_df)
...
#now let's plot it
plt.title("dataset 1")
plt.plot(dataset1.loc[:,"x"],dataset1.loc[:,"y"],"o",color="black")
plt.show()
